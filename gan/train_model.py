...
def main(cfg):
    for fraction in [0.01, 0.02, 0.03, 0.05, 0.08]:
        ...
        if cfg.hyperparameters.dataset == "dummy":
            ...
            data_module = AudioDataModule(VCTK_clean_path, VCTK_noisy_path, VCTK_test_clean_path, VCTK_test_noisy_path, batch_size=cfg.hyperparameters.batch_size, num_workers=cfg.system.num_workers, fraction=fraction, authentic=False)
