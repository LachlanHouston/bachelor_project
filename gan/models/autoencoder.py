...
class Autoencoder(L.LightningModule):
    ...
    def configure_optimizers(self):
        g_opt = torch.optim.RMSprop(self.generator.parameters(), lr=self.g_learning_rate)#, betas = (0., 0.9))
        d_opt = torch.optim.RMSprop(self.discriminator.parameters(), lr=self.d_learning_rate)#, betas = (0., 0.9))
        return [g_opt, d_opt], []
