...
class Autoencoder(L.LightningModule):
    ...
    def _get_reconstruction_loss(self, real_noisy, fake_clean, D_fake, p=1):
        ...
        G_fidelity_loss = G_fidelity_loss / real_noisy.numel()
    ...
    def training_step(self, batch, batch_idx):
        ...
        D_loss, D_gp_alpha, D_adv_loss, L2_penalty_bias = self._get_discriminator_loss(real_clean=real_clean, fake_clean=fake_clean.detach(), D_real=D_real, D_fake_no_grad=D_fake_no_grad)
