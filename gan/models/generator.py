...
class Generator(nn.Module):
    def __init__(self, param=None, in_channels=2, out_channels=2):
        ...
        # Encoder
        self.encoder.append(ConvBlock(self.in_channels, 32, kernel_size=(5, 2), stride=(2, 1), padding=(2, 1))) # B, 32, 129, 321
        ...
        self.decoder.append(TransConvBlock(64, self.out_channels, kernel_size=(5, 2), stride=(2, 1), padding=(2, 0), output_padding=(0, 0), is_last=True)) # B, 2, 257, 321
