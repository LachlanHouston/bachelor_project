...
class Generator(nn.Module):
    def __init__(self, param=None, in_channels=2):
        ...
        self.rnn_block = DPRNN(256, rnn_type='LSTM', hidden_size=256, output_size=256, num_layers=2, bidirectional=True)
        ...
        # Decoder
        self.decoder.append(TransConvBlock(512, 128, kernel_size=(5, 2), stride=(2, 1), padding=(2, 1), output_padding=(1, 0)))
