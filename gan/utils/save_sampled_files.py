...
if __name__ == '__main__':
    ...
    for i, batch in enumerate(data_loader):
        ...
        torchaudio.save(f'/Users/fredmac/Library/CloudStorage/OneDrive-DanmarksTekniskeUniversitet/bachelor_project/data/test_noisy_sampled/{noisy_filename}', noisy_wav, 16000)
