...
noisy_path = 'data/AudioSet/train_raw/'
device = torch.device('mps')

if __name__ == '__main__':
    dataset = AudioDataset(clean_path=clean_path, noisy_path=noisy_path, is_train=False, authentic=True)
    ...
    for i, batch in tqdm.tqdm(enumerate(data_loader)):
        ...
        # torchaudio.save(f'/Users/fredmac/Library/CloudStorage/OneDrive-DanmarksTekniskeUniversitet/bachelor_project/data/test_clean_sampled/{clean_filename}', clean_wav, 16000)
        torchaudio.save(f'/Users/fredmac/Library/CloudStorage/OneDrive-DanmarksTekniskeUniversitet/bachelor_project/data/AudioSet/train_sampled/{noisy_filename}', noisy_wav, 16000)
