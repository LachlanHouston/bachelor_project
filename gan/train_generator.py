...
# Import data
from gan import AudioDataModule, DummyDataModule, MixDataModule, pl_Generator
...
def main(cfg):
    ...
    model = pl_Generator(batch_size=cfg.hyperparameters.batch_size, g_learning_rate=cfg.hyperparameters.g_learning_rate, 
